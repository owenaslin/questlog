...
function QuestTypeToggle({
  ...
  return (
    <div>
      ...
      <p className="text-body-sm text-[--parchment-dim] mt-1.5 opacity-70">
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-5">
      ...
      <button
        type="submit"
        disabled={!canSubmit}
        className={`tavrn-btn tavrn-btn-lg w-full ${
          canSubmit
            ? "tavrn-btn-primary"
            : "tavrn-btn-ghost opacity-50 cursor-not-allowed"
        }`}
      >
        ⚡ Ask the Quest Giver
      </button>
    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-5">
      ...
      <div>
        ...
        <input
          ...
          required
        />
        <p className="text-body-sm text-[--parchment-dim] mt-1 opacity-60">
      ...
      <p className="text-body-sm text-[--parchment-dim] text-center opacity-60">
      ...
      >
        ...
        >
          ...
          <button
            type="button"
            onClick={onClose}
            className="text-body-sm text-[--parchment-dim] hover:text-tavern-parchment px-2"
            aria-label="Close"
          >
            ✕
          </button>
        ...
        <div className="p-5">
              ...
              {([["ai", "⚡ Quest Giver"], ["user", "✎ Write It"]] as [Mode, string][]).map(
                ([m, label]) => (
                  <button
                    ...
                    className={`text-body-sm font-medium px-5 py-2 transition-none ${
                      mode === m
          ...
          {stage === "loading" && (
            <div className="flex flex-col items-center py-10 gap-6">
              ...
              <div className="text-center">
                <p className="text-body-sm font-medium text-tavern-gold mb-2">
          ...
          {stage === "preview" && preview && (
            <div>
              ...
              <h3 className="text-body-sm font-semibold text-tavern-parchment leading-snug mb-3">
                {preview.title}
              </h3>
              <p className="text-body text-[--parchment-dim] leading-relaxed mb-5">
                {preview.description}
              </p>
          ...
          {stage === "done" && (
            <div className="flex flex-col items-center py-8 gap-5 text-center">
              ...
              <div>
                ...
                <p className="text-body text-[--parchment-dim] leading-relaxed">
              ...
              <div className="flex flex-col gap-3 w-full">
                {savedQuestId && (
                  <Link
                    ...
                    onClick={onClose}
                    className="tavrn-btn tavrn-btn-primary tavrn-btn-lg w-full justify-center"
                  >
                    View Quest →
                  </Link>
                )}
                <Link
                  href="/journal"
                  onClick={onClose}
                  className="tavrn-btn tavrn-btn-ghost w-full justify-center"
                >
                  View in Journal →
                </Link>
                <button
