      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-2 border-b-4 border-tavern-oak-dark bg-tavern-smoke">
          ...
          <button
            ...
            className="text-body-sm text-tavern-smoke-light hover:text-tavern-parchment px-1 leading-none"
        ...
        <div className="p-4 flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-body-sm text-tavern-smoke-light leading-relaxed mb-3">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="text-body-sm font-medium px-4 py-2 min-h-[36px] bg-tavern-gold text-retro-black border-b-4 border-tavern-gold-dark hover:bg-tavern-candle active:border-b-0 active:translate-y-1 transition-none"
              >
                ▶ Install
              </button>
              <button
                type="button"
                onClick={handleLater}
                className="text-body-sm font-medium px-4 py-2 min-h-[36px] border-2 border-tavern-oak text-tavern-parchment hover:border-tavern-gold transition-none"
              >
                Later
              </button>
            </div>
