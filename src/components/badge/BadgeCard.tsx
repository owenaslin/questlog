...
export default function BadgeCard({
  ...
  return (
    ...
    >
      {/* New indicator */}
      {isNew && (
        <div className="absolute -top-2 -left-2 bg-retro-yellow text-retro-black text-body-sm font-bold px-2 py-1 border-2 border-retro-black">
          NEW!
        </div>
      )}
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2 mb-1">
          <h3 className="text-body-sm font-semibold text-retro-yellow truncate">
        ...
        {isLocked && (
          <p className="text-body-sm text-retro-gray mt-2 italic">
