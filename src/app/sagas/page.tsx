    ...
    <div>
      ...
      <div className="text-center mb-8">
        ...
        <p className="font-pixel text-retro-lightgray text-[10px] max-w-2xl mx-auto leading-loose">
          Embark on epic multi-part journeys. Complete sagas step by step, or forge your own path through skill trees.
        </p>
      </div>
      ...
      <div className="mt-12 bg-retro-darkgray border-4 border-retro-black p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <h3 className="font-pixel text-retro-yellow text-xs mb-2">📋 Linear Sagas</h3>
