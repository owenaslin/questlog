    ...
    <div className="grid grid-cols-1 xl:grid-cols-[minmax(0,1fr)_300px] gap-6">
      ...
      <section className="tavrn-panel p-5 md:p-7">
        <div className="flex flex-col gap-6">
          <header className="flex flex-wrap items-end justify-between gap-4 border-b border-tavern-oak pb-4">
            <div>
              <h1 className="tavrn-wordmark text-4xl leading-none">tavrn</h1>
              <p className="text-[11px] text-tavern-parchment-2 mt-2 tracking-wide">a quiet corner of your life</p>
            </div>
          ...
          <div className="tavern-card p-4 md:p-5">
            ...
            <p className="text-[14px] leading-relaxed text-tavern-parchment">
              {isLoggedIn
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center justify-between gap-2 mb-3">
                        ...
                        <span className="font-pixel text-[7px] text-tavern-lime">+{quest.xp_reward} XP</span>
                      </div>
                      <p className="font-pixel text-[9px] text-tavern-parchment mb-2 leading-relaxed">
                        {quest.title}
                      </p>
                      <p className="text-[12px] text-tavern-parchment-dim leading-relaxed">{blurb}</p>
                    </button>
                  );
                })}
          </div>
      ...
      <aside className="flex flex-col gap-4">
        ...
        <div className="tavrn-panel p-4">
          ...
          {isLoggedIn ? (
            <div className="mt-3">
              {dataLoading
                ? <div className="h-2 bg-tavern-smoke/40 border border-tavern-oak animate-pulse" />
            ...
            <>
              <p className="text-[12px] text-tavern-parchment-dim mt-2">Level up by finishing one quest tonight.</p>
              <div className="mt-4 h-2 bg-tavern-smoke/40 border border-tavern-oak">
